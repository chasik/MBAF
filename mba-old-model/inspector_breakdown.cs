...
namespace mba_old_model
{
    ...
    public partial class inspector_breakdown
    {
        public int inspector_breakdown_id { get; set; }
        public Nullable<int> inspector_id { get; set; }
        public Nullable<int> zip_from { get; set; }
        public Nullable<int> zip_to { get; set; }
