...
namespace mba_old_model
{
    ...
    public partial class forms_events
    {
        ...
        public int forms_events_id { get; set; }
        public Nullable<int> forms_parts_id { get; set; }
        public string forms_events_name { get; set; }
        public Nullable<byte> forms_events_default { get; set; }
