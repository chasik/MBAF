    ...
    internal sealed class Configuration : DbMigrationsConfiguration<mba_model.ModelContext>
    {
        ...
        protected override void Seed(mba_model.ModelContext context)
        {
            ...
            context.Clients.AddOrUpdate(
                ...
                new Client { Id = 15, ParentId = null, InnerId = 238, Name = "Ханты-Мансийский банк Открытие", FullName = "ПАО \"Ханты-Мансийский банк Открытие\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 16, ParentId = null, InnerId = 240, Name = "Траст", FullName = "ПАО НБ \"Траст\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 17, ParentId = null, InnerId = 242, Name = "Лето Банк", FullName = "ПАО \"Лето Банк\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 18, ParentId = null, InnerId = 245, Name = "СКБ-банк", FullName = "ОАО \"СКБ-банк\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 19, ParentId = null, InnerId = 246, Name = "БИНБАНК кредитные карты", FullName = "АО \"БИНБАНК кредитные карты\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 20, ParentId = null, InnerId = 249, Name = "Банк Москвы", FullName = "Банк Москвы", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 21, ParentId = null, InnerId = 251, Name = "ПАО Сбербанк", FullName = "Публичное акционерное общество «Сбербанк России»", Image = "ClientSber.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 22, ParentId = null, InnerId = 252, Name = "Азиатско-Тихоокеанский Банк", FullName = "ПАО \"Азиатско-Тихоокеанский Банк\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 23, ParentId = null, InnerId = 253, Name = "РОСБАНК", FullName = "ПАО \"РОСБАНК\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 24, ParentId = null, InnerId = 254, Name = "БИНБАНК", FullName = "ПАО \"БИНБАНК\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 25, ParentId = null, InnerId = 255, Name = "МОСКОВСКИЙ КРЕДИТНЫЙ БАНК", FullName = "ОАО \"МОСКОВСКИЙ КРЕДИТНЫЙ БАНК\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 26, ParentId = null, InnerId = 256, Name = "Амант", FullName = "ООО \"Амант\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 27, ParentId = null, InnerId = 257, Name = "РОСТ БАНК", FullName = "АО \"РОСТ БАНК\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 28, ParentId = null, InnerId = 258, Name = "Кедр", FullName = "КБ \"Кедр\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 },
                new Client { Id = 29, ParentId = null, InnerId = 413, Name = "Выручай-Деньги", FullName = "ООО МФО \"Выручай-Деньги\"", Image = "ClientDefault.png", Created = DateTime.Now, CreatedBy = 1 }
                );
            #endregion
